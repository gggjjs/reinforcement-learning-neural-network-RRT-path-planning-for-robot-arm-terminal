...
%%%%%%%%%%%%%%
            ...
            j5=atj5.T;
            j6=atj6.T;
            llength2 = [j2(1,4),j2(2,4),j2(3,4)]; % return all axis positions
            llength3 = [j3(1,4),j3(2,4),j3(3,4)];
            llength3_bu =  [j3_bu(1,4),j3_bu(2,4),j3_bu(3,4)];
            llength4 = [j4(1,4),j4(2,4),j4(3,4)];
            llength5 = [j5(1,4),j5(2,4),j5(3,4)];
            llength6 = [j6(1,4),j6(2,4),j6(3,4)];
%%%%%%%%%%%%%%
%             try
%                 llength2 = [atj2(1,4),atj2(2,4),atj2(3,4)]; % return all axis positions
%             catch ME
%                 disp('Error accessing atj2:')
%                 disp(atj2)
%                 rethrow(ME)
%             end
%              
...
%                 realdistance_9 = distance(llength6,obstacle(jjj,:));
                ...
                realdistance_6 = pdist2(llength3,obstacle(jjj,:), 'euclidean');
                realdistance_7 = pdist2(llength4,obstacle(jjj,:), 'euclidean');
                realdistance_8 = pdist2(llength5,obstacle(jjj,:), 'euclidean');
                realdistance_9 = pdist2(llength6,obstacle(jjj,:), 'euclidean');
