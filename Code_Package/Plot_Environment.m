...
hold on; plot3(obstacle(:,1),obstacle(:,2),obstacle(:,3),'ks','MarkerFaceColor','k','MarkerSize',100); view(3); % MarkerSize 表示点的大小，b.表示绿色的点
hold on; plot3(terminal(:,1),terminal(:,2),terminal(:,3),'y.','MarkerSize',100);view(3);